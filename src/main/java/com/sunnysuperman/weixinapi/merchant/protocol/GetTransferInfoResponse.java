...
public class GetTransferInfoResponse extends PayApiResponse {
    private String partner_trade_no; // 商户单号
    ...
    private int payment_amount;// 付款金额
    private String transfer_time;// 转账时间
    private String desc;// 付款描述
